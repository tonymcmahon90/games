// shows two 3D triangles, press F11 to toggle fullscreen and ESC to quit
#include <Windows.h> 
#include <d3d9.h>
...
{
	{0.5f,1.0f,0.0f,D3DCOLOR_XRGB(0,255,255),},    // triangle 0
	{1.0f,0.0f,0.0f,D3DCOLOR_XRGB(255, 255, 0),},
	{0.0f,0.0f,0.0f,D3DCOLOR_XRGB(255, 0, 255),},

	{-0.5f,1.0f,0.0f,D3DCOLOR_XRGB(0,0,255),},		// triangle 1
...
void RenderD3D()
{
	...
	d3dDevice->SetRenderState(D3DRS_LIGHTING, FALSE); // using custom 
